...
<center>
	<form action="ftdate.php" method="GET">
	Enter FROM-date:
...
$fpi = $_GET['fdate'];
$tpi = $_GET['tdate'];
$fDate=date('Y-m-d',strtotime($fpi));
$tDate=date('Y-m-d',strtotime($tpi));
           $host="127.0.0.1";
		  $dbusername="root";
		  $dbpassword="";
		  ...
		  $query="SELECT * FROM complaint WHERE date >='$fDate' AND date <='$tDate' ";
		  ...
		  {
			  echo "No complaints are reported between given dates.";
		  }	  
?>
